...
class BlogsUpdateRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            "author_url_portrait" => "required|string",
            "author_url_landscape" => "required|string",
    ...
    public function data(): array
    {
        ...
        return [
            ...
            "author_url_portrait" => $this->input("author_url_portrait"),
            "author_url_landscape" => $this->input("author_url_landscape"),
