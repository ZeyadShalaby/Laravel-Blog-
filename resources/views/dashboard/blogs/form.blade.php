          ...
          <div class="col-12">
            ...
            <form id="BlogsForm">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  <label class="form-label font-weight-bolder">Author Url Landscape</label>
                  <input type="text" class="form-control" id="blogsAuthorUrlLandscape">
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                  <label class="form-label font-weight-bolder">Author Url Portrait</label>
                  <input type="text" class="form-control" id="blogsAuthorUrlPortrait">
                </div>
                <div class="col-12">
                  <hr>
                </div>
...
<script>
  ...
  let quill = new Quill(
    "#blogsContent", {
      ...
      placeholder: "Compose a a new post",
      theme: "snow"
    }
  );
  function clearForm() {
    ...
    $("#blogsAuthorUrlLandscape").val(null);
    $("#blogsAuthorUrlPortrait").val(null);
    $("#blogsTags").val(null);
      ...
      if (formSubmitted !== true) {
        ...
        $.ajax({
          ...
          data: JSON.stringify({
            ...
            author_url_landscape: $("#blogsAuthorUrlLandscape").val(),
            author_url_portrait: $("#blogsAuthorUrlPortrait").val(),
            tags: $("#blogsTags").val(),
